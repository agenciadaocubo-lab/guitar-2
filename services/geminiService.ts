...
export async function generateLessonContent(
  ...
  const prompt = `
    ...
    3. Para cada nota no braço (fretboard), o campo "label" DEVE conter o número do grau e o nome da nota no formato "Número - Nota" (Ex: "1 - C", "2 - D", "b3 - Eb", "5 - G").
    ...
    - DEVE ser no formato ASCII tradicional de 6 linhas.
    - Começando da corda mais fina (e) até a mais grossa (E).
      ...
      responseSchema: {
        ...
        properties: {
          ...
          fretboardNotes: {
            ...
            items: {
              ...
              properties: {
                ...
                label: { type: Type.STRING, description: "Grau e Nota no formato 'Número - Nota' (ex: 1 - C, b3 - Eb). USE NÚMEROS NORMIAIS." },
          ...
          fretboardRange: {
            ...
            description: "Array com [trasteInicial, trasteFinal] para visualização"
          },
          scaleTab: { type: Type.STRING, description: "Tablatura ASCII de 6 linhas formatada" },
